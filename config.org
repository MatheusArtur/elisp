...
#+BEGIN_SRC emacs-lisp
  ...
  (defun launch-browser ()
    (interactive)
    (exwm-async-run "google-chrome-stable"))
  ...
  (global-set-key (kbd "s-s") 'launch-slack)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun screenshot-window ()
     ...
     (message "Screenshot taken!"))
   (global-set-key (kbd "<mouse-9>") 'screenshot-window)
#+END_SRC
