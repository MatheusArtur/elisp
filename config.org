...
#+BEGIN_SRC emacs-lisp
	...
	(require 'exwm-randr)
	(setq exwm-randr-workspace-output-plist '(0 "HDMI1")) ;; DP-1 being the name of my new monitor as shown by `randr'
	(add-hook 'exwm-randr-screen-change-hook
		  (lambda ()
		    (start-process-shell-command
		     "xrandr" nil "xrandr --output HDMI1 --left-of LVDS1 --auto"))) ;; eDP-1 being the name of my original (laptop) monitor
	(exwm-enable)
	(exwm-randr-enable)
