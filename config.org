...
#+BEGIN_SRC emacs-lisp
  ...
  (global-set-key (kbd "s-d") 'launch-discord)
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun audio/mute ()
    (interactive)
    (start-process "audio-mute" nil "amixer" "set" "Master" "toggle"))

  (defun audio/raise-volume ()
    (interactive)
    (start-process "raise-volume" nil "amixer" "set" "Master" (concat volVar "%+")))

  (defun audio/lower-volume ()
    (interactive)
    (start-process "lower-volume" nil "amixer" "set" "Master" (concat volVar "%-")))

  (defun capture/mute ()
    (interactive)
    (start-process "capture-mute" nil "amixer" "sset" "Capture" "toggle"))

  (global-set-key (kbd "<XF86AudioMute>") 'audio/mute)
  (global-set-key (kbd "<XF86AudioRaiseVolume>") 'audio/raise-volume)
  (global-set-key (kbd "<XF86AudioLowerVolume>") 'audio/lower-volume)
  (global-set-key (kbd "<XF86AudioMicMute>") 'capture/mute)
#+END_SRC
